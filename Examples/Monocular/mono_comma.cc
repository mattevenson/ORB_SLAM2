...
int main(int argc, char **argv)
{
    ...
    {
        cerr << endl
             << "Usage: ./mono_comma path_to_vocabulary path_to_settings path_to_sequence num_frames" << endl;
        return 1;
    }
...
void LoadImages(const string &strPathToSequence, int nFrames, vector<string> &vstrImageFilenames, vector<double> &vTimestamps)
{
